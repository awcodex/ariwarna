...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		$menu = array(
			'page_title' => __( 'Theme Setting By: AwCodex' , 'textdomain' ),
			'menu_title' => __( 'Hg-themes Setting', 'textdomain' ),
     ...
     */
	 function options_page() { ?>
		...
		<div class="span-4">
	    <h2 class="nav-tab-wrapper menuk">
	...
	function optionsframework_admin_bar() {
		...
		$wp_admin_bar->add_menu( array(
			//'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Hg-themes Setting', 'textdomain' ),
